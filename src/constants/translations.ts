...
export interface TranslationStrings {
  // Language selection (used by HelperRobot)
  yourLanguage?: string;
  languageToLearn?: string;
  goBack?: string;
  startJourney?: string;
  
  // Helper Robot dialogue
  whatLanguage?: string;
  whatToLearn?: string;
  ready?: string;
  ...
  clickMeToSeeProgress?: string;
  clickMeToCreateAccount?: string;
  clickMe?: string;
  ...
  playPronunciationTooltip?: string;
  showExplanationTooltip?: string;
  addToDictionary?: string;
  signInToAddWords?: string;
  explainSentenceStructure?: string;
  goBackToPreviousStep?: string;
  replayYourRecording?: string;
  ...
  checkingSentence?: string;
  errorCheckingSentence?: string;
...
export const translations: Record<'en', TranslationStrings> = {
  en: {
    ...
    clickMeToSeeProgress: "Click me to see your progress!",
    clickMeToCreateAccount: "Click me to create an account!",
    clickMe: "Click me!",
    ...
    playPronunciationTooltip: 'Play pronunciation',
    showExplanationTooltip: 'Show explanation',
    addToDictionary: 'Add to dictionary',
    signInToAddWords: 'Sign in to add words to dictionary',
    explainSentenceStructure: 'Explain sentence structure',
    goBackToPreviousStep: 'Go back to previous step',
    replayYourRecording: 'Replay your recording',
    ...
    turiPreparingQuiz: 'Turi is preparing your quiz...',
    goToQuiz: 'Go to Quiz',
    question: 'Question',
    correct: 'correct',
    ...
    errorCheckingSentence: 'Error checking sentence. Please try again.',
